...
using static InYourInterest.Common.GlobalConstants;

namespace InYourInterest.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
           ...
           IEmailSender emailSender, IUsersService usersService)
        {
        ...
        public class InputModel
        {
            ...
            //[Min(UserMinAge, ErrorMessage = UserAgeRestrictionErrorMessage)]
