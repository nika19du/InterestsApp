...
using InYourInterest.Infrastructure.Attributes;
...
using static InYourInterest.Common.ErrorMessages;
using static InYourInterest.Common.GlobalConstants;

namespace InYourInterest.Areas.Identity.Pages.Account.Manage
{
